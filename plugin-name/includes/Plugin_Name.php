...
final class Plugin_Name {
	 ...
	 * - \Plugin_Name\Plugin_Name_Helpers. Defines all all helper methods and plugin wide variables.
	 *
	 * @since  1.0.0
	 * @access private
	 */
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once \Plugin_Name\PLUGIN_PATH . 'includes/Plugin_Name_i18n.php';

		/**
		 * The class responsible for defining all helper methods and plugin wide variables.
		 */
		require_once \Plugin_Name\PLUGIN_PATH . 'includes/Plugin_Name_Helpers.php';

		/**
		 * The class responsible for the WordPress Gutenberg Blocks functionality.
		 */
		require_once \Plugin_Name\PLUGIN_PATH . 'includes/Plugin_Name_Blocks.php';
	}
	...
	public function filter_wp_kses_allowed_html( array $html, string $context ): array {
		if ( ! in_array( $context, array( 'pavb_forms', 'post', 'page' ), true ) ) {
			return $html;
		}
